  ...
  !(function () {
    ...
    (e.use = function (t) {
      e.Base.prototype.callActions.call(e, "beforeUse", arguments),
        "function" == typeof t && "mixitup-extension" === t.TYPE
          ...
          : t.fn && t.fn.jquery && ((e.libraries.$ = t), e.registerJqPlugin(t)),
    ...
    n.extend(e.Mixer.prototype, {
      ...
      diffDatasets: function (t) {
            ...
            l.isInDom
              ? ((f = l.dom.el.nextElementSibling),
                ...
                u &&
                  ...
                  a.insertDatasetFrag(u, l.dom.el, a.targets.indexOf(l), r),
                  (u = null)))
        ...
        for (
          u &&
            ...
            a.insertDatasetFrag(u, f, a.dom.targets.length, r)),
            m = 0;
          (s = t.startDataset[m]);
          m++
        )
      ...
      insertDatasetFrag: function (t, e, n, a) {
        ...
        for (i.dom.parent.insertBefore(t, e); a.length; )
          i.targets.splice(n, 0, a.shift()), n++;
      },
    ...
    "object" == typeof exports && "object" == typeof module
      ...
      : ("undefined" != typeof t.mixitup && "function" == typeof t.mixitup) ||
        (t.mixitup = t.mixItUp = e),
    (a = t.$ || t.jQuery) && a.fn.jquery && e.registerJqPlugin(a),
    e.BaseStatic.call(e.constructor),
    (e.NAME = "mixitup"),
    (e.CORE_VERSION = "3.1.12");
})(window);
